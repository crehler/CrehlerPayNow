    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new ManyToOneAssociationField('transaction', 'transaction_id',
                OrderTransactionDefinition::class, 'id',  false),
            ...
            (new StringField('refund_id', 'refundId', 1024))->addFlags(new Required()),
            new StringField('paynow_status', 'paynowStatus', 1024),
            (new FloatField('refund_amount', 'refundAmount'))->addFlags(new Required()),
