...
class RefundController extends AbstractController
{
    ...
    private EntityRepositoryInterface $payNowRefundHistoryRepository;
    ...
    public function __construct(
        ...
        EntityRepositoryInterface $payNowRefundHistoryRepository,
     ...
     * @Since("1.0.0")
     * @Route(
     *     "/api/paynowpayment/refund-payment",
     *     name="paynowpayment.api.refund",
     *     methods={"POST"},
     ...
     * @Since("1.0.0")
     * @Route(
     *     "/api/paynowpayment/fetch-refund-payment",
     *     name="paynowpayment.api.fetch-refund",
     *     methods={"POST"},
     *     defaults={"auth_required"=true})
     */
     ...
     * @Since("1.0.0")
     * @Route(
     *     "/api/paynowpayment/test-api",
     *     name="paynowpayment.api.test-api",
     *     methods={"POST"},
     *     defaults={"auth_required"=true})
     */
